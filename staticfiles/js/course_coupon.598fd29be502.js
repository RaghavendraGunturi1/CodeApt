(function(){
    ...
    function attach(){
        ...
        const subjectSlug = (function(){
            // try to derive subject slug from buy button href
            try{ const url = new URL(buyBtn.href, window.location.origin); return url.pathname.split('/').filter(Boolean).pop(); }catch(e){ return '' }
        })();
